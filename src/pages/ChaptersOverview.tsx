...
const ChaptersOverview = () => {
  const [expandedChapters, setExpandedChapters] = useState<Set<string>>(new Set(['data-structures']));
      ...
      <ContentSection className="container mx-auto px-8 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="font-body text-xl text-muted-foreground leading-relaxed">
            Explore how software really works, from the fundamental building blocks to complex systems.
          </p>
        </div>
      </ContentSection>
          ...
          {isLoading ? (
            ...
            <div className="space-y-6">
              {chapters?.map((chapter) => {
                ...
                return (
                  <div key={chapter.id} className="border border-border/50 rounded-lg overflow-hidden bg-card/30 backdrop-blur-sm">
                    {/* Chapter Header */}
                    <button
