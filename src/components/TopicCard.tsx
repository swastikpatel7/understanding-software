...
// component's state changes but the props for this component remain the same. This is
// particularly effective when TopicCard is rendered in a list or grid, improving UI
